...
class Selenium_Extended:
    ...
    def wait_and_input_text(self, locator, text, timeout=None):
        timeout = timeout if timeout else self.default_timeout  # uses default timeout variable unless user specifies
        # timeout length when calling function

        WebDriverWait(self.driver, timeout).until(  # passes timeout value into the wait function
